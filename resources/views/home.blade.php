...
<main>
        <article class="container-fluid">
            <section class="mx-3">
                <div class="headlines">
                    <h1>ARTICLE</h1>
                    <img src="assets/pic/img-headlines.jpg" alt="img-headlines">
                </div>
            </section>
            <section class="row align-items-center mx-2 mt-5 mb-4">
                ...
                <div class="col-3">
                    <div class="d-flex align-items-center">
                        <button class="btn">
                            <img src="assets/pic/search.jpg" alt="search-icon" width="25">
                        </button>
                ...
                <div class="col-4 py-3">
                    <div class="card h-100 border-0 bg-light shadow-sm" style="padding: 20px;">
                        <a href="article1.html" class="stretched-link" style="text-decoration: none;">
                            <img src="assets/pic/card-1.jpg" alt="article-1" style="width: 100%;">
                ...
                <div class="col-4 py-3">
                    <div class="card h-100 border-0 bg-light shadow-sm" style="padding: 20px;">
                        <a href="article2.html" class="stretched-link" style="text-decoration: none;">
                            <img src="assets/pic/card-2.jpg" alt="article-1" style="width: 100%;">
                ...
                <div class="col-4 py-3">
                    <div class="card h-100 border-0 bg-light shadow-sm" style="padding: 20px;">
                        <a href="article3.html" class="stretched-link" style="text-decoration: none;">
                            <img src="assets/pic/card-3.jpg" alt="article-1" style="width: 100%;">
